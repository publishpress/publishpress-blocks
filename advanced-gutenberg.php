...
if (! defined('ADVANCED_GUTENBERG_LOADED')) {
    ...
    if (! defined('ADVANCED_GUTENBERG_VERSION')) {
        define('ADVANCED_GUTENBERG_VERSION', '3.3.4-beta2');
    }
    ...
    if (! defined('ADVANCED_GUTENBERG_UPGRADE_LINK')) {
        define('ADVANCED_GUTENBERG_UPGRADE_LINK', 'https://publishpress.com/links/blocks-menu');
    }
