...
- [ ] Monitor [GitHub Actions](https://github.com/publishpress/publishpress-blocks/actions)
- [ ] Verify [WordPress.org plugin page](https://wordpress.org/plugins/advanced-gutenberg/)
