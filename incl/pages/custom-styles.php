            ...
            <div id="advgb-customstyles-list">
                <div id="mybootstrap">
                    <ul class="advgb-customstyles-list">
                        <?php
                        $content = '<li style="text-align: center; margin-top: 40px"><a class="advgb-customstyles-new top-button button button-secondary">' . esc_html__( 'Add new style', 'advanced-gutenberg' ) . '</a></li>';
                        ...
                        $content .= '<li style="text-align: center; margin-top: 40px"><a class="advgb-customstyles-new button button-secondary">' . esc_html__( 'Add new style', 'advanced-gutenberg' ) . '</a></li>';
